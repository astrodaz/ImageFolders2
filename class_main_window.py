...
class MainWindow(wx.Frame):
    ...
    def InitUI(self):
        ...
        self.Bind(wx.EVT_BUTTON, self.fitsimagetypes, self.btnFitsTypes)
    ...
    def fitsimagetypes(self, event):
        from class_fits_imagetyp import FitsImageTypeWindow
        fit = FitsImageTypeWindow(self, title='FITS Image Type')
        fit.ShowModal()
